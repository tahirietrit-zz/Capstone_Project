...
public class FeedProvider extends ContentProvider {
    ...
    private static final String TRIP_BY_LAST = Item.CONTENT_ITEM_TYPE + "limit 1";

    static UriMatcher buildUriMatcher() {
        final UriMatcher matcher = new UriMatcher(UriMatcher.NO_MATCH);
        final String authority = Item.BASE_CONTENT_URI.toString();
    ...
    private int match_uri(Uri uri) {
        ...
        {
            if (link.contentEquals(Item.BASE_CONTENT_URI.toString())) {
                return MATCHES_ALL;
            } else if (link.contentEquals(Item.buildWithLastTrip().toString())) {
                return MATCHES_LAST;
            }
        }
        return -1;
            ...
            case MATCHES_ALL:
                ...
                try {
                    for (ContentValues value : values) {
                        long _id = db.insertWithOnConflict(Item.REPORT_TABLE, null, value,
